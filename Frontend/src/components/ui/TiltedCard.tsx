    ...
    >
      ...
      >
        {imageSrc ? (
          ...
          <div
            className="absolute top-0 left-0 bg-[var(--surface)] border border-[var(--border)] rounded-[15px] will-change-transform [transform:translateZ(0)] flex items-center justify-center"
            style={{
              width: imageWidth,
              height: imageHeight
            }}
